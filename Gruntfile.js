...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: ['docs/assets/js/src/*.js', 'docs/assets/js/*.js', '!docs/assets/js/*.min.js', '!docs/assets/js/webfont.js']
      }
    },
    ...
    concat: {
      ...
      bootstrap: {
        src: [
          ...
          'js/bootstraphy.js',
          'js/bootstraphy.checker.js',
          'js/bootstraphy.dropdown.js',
          'js/bootstraphy.file.js',
          'js/bootstraphy.tabs.js',
          'js/bootstraphy.useragent.js'
        ],
